...
export const activeJobs = [
  ...
  },
  {
    ...
    date: "23/11/2025",
    description:
      "Join our team to build cutting-edge user interfaces using React and Next.js Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
    tags: [
      "Experience: 2 Year",
      "Remote",
      "Salary: Bi-weekly",
  ...
  },
  {
    ...
    date: "17/11/2025",
    description:
      "We need a Node.js developer Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
    tags: [
      "Experience: 4 Year",
      "Full Time",
      "Salary: Monthly",
  ...
  },
  {
    ...
    date: "25/11/2025",
    description:
      "Looking for a proactive PM Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    date: "21/11/2025",
    description:
      "Ensure product quality through testing Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    date: "19/11/2025",
    description:
      "Craft SEO-optimized blog posts Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
    tags: [
      "Experience: 1 Year",
      "Freelance",
      "SEO Writing",
  ...
  },
  {
    ...
    date: "23/11/2025",
    description:
      "Design marketing materials Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
...
export const workers = [
  ...
  },
  {
    ...
    availability: "Remote",
    description:
      "Frontend dev specializing in React orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    availability: "Remote",
    description:
      "Experienced in Node.js APIs orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    availability: "Freelance",
    description:
      "Skilled in branding and UI orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
    skills: ["Figma", "Photoshop", "Illustrator"]
  },
  {
    name: "Hassan Malik",
    ...
    availability: "Hybrid",
    description:
      "Flutter developer for iOS/Android orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    availability: "Remote",
    description:
      "SEO writer for tech blogs orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
  ...
  },
  {
    ...
    availability: "Remote",
    description:
      "Manual & automated testing expert orem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium at quaerat laborum perferendis molestiae! Perspiciatis possimus explicabo modi ea. Atque ipsum magnam vel dolor repudiandae adipisci enim provident minima, quia fugiat dignissimos iure quidem blanditiis optio exercitationem libero architecto earum temporibus deleniti accusamus voluptate vitae eius consequuntur. Quidem quod provident animi eveniet in quam accusamus debitis nisi, error molestias, facilis natus vel quis reiciendis excepturi repudiandae aperiam ipsam sunt consequuntur officia delectus alias at exercitationem enim? Rem eligendi earum perspiciatis cumque neque quia corrupti nostrum, dolore maxime enim suscipit dolorum atque labore! Perspiciatis explicabo atque doloremque sit similique nesciunt magnam.",
...
const AllJobs = () => {
  ...
  const filteredJobs = activeJobs.filter(job => {
    ...
    const matchesAvailability = availability
      ? job.availability.toLowerCase() === availability.toLowerCase()
      : true;
    const matchesSkill = skill
      ? job.skills.some(s => s.toLowerCase().includes(skill.toLowerCase()))
      : true;
    return (
      matchesSearch && matchesLocation && matchesAvailability && matchesSkill
    );
  });
  ...
  const filteredWorkers = workers.filter(worker => {
    ...
    const matchesLocation = location
      ? worker.location.toLowerCase() === location.toLowerCase()
      : true;
    const matchesAvailability = availability
      ? worker.availability.toLowerCase() === availability.toLowerCase()
      : true;
    const matchesSkill = skill
  ...
  return (
    <div className='space-y-6 rounded-[16px] bg-white p-8'>
      {/* Tabs */}
      <div className='flex items-center gap-6 border-b'>
        <button
          onClick={() => setActiveTab("jobs")}
          className={`flex flex-wrap items-center gap-2 border-b-2 pb-2 text-sm font-medium ${activeTab === "jobs" ? "border-[#559092] text-black" : "border-transparent text-gray-500"}`}
        >
          <span>Active Job Posts</span>
          <span
            className={`rounded-[10px] px-3 py-2 ${activeTab === "jobs" ? "bg-[#559093] text-white" : "bg-[#E2E2E2] text-[#637381]"}`}
          >
            {filteredJobs.length}
          </span>
        </button>
        <button
          ...
          className={`flex flex-wrap items-center gap-2 border-b-2 pb-2 text-sm font-medium ${activeTab === "profiles" ? "border-[#559092] text-black" : "border-transparent text-gray-500"}`}
        >
          <span>Worker Profiles</span>
          <span
            className={`rounded-[10px] px-3 py-2 ${activeTab === "profiles" ? "bg-[#559093] text-white" : "bg-[#E2E2E2] text-[#637381]"}`}
          >
