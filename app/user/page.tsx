        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            <div className="flex flex-col items-center">
              <img
                ...
                alt="Profile Picture"
              />
              <h2 className="text-2xl font-bold mt-4">Jese Leos</h2>
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-700 mb-2">
                <strong>Home address:</strong> 92 Miles Drive, Newark, NJ 07103,
          ...
          <div className="lg:col-span-2 bg-white shadow-md rounded-lg p-8">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div>
                <p>
                  <strong>Education:</strong> Thomas Jeff High School, Stanford
                  University
                </p>
              </div>
              <div>
              ...
              <div>
                <p>
                  <strong>Languages:</strong> English, German, Italian, Spanish
                </p>
              </div>
              <div>
                <p>
