    ...
    <div className='relative flex min-h-[400px] flex-col justify-between rounded-xl border bg-white p-4 shadow-sm'>
      ...
      <div className='relative mb-3 flex items-start justify-between'>
        <div
          ...
          onClick={() => router.push("/en/employer/view-profile/7")}
        >
          {isCompany ? (
      ...
      {/* Badge */}
      <span
        className={`mb-3 inline-block max-w-[90px] rounded-full px-2 py-2 text-[10px] font-[400] ${
          status === "Open to work"
            ? "border-[0.6px] border-[#35CC6B] bg-[#35CC6B2B] text-[#35CC6B]"
            : "border-[0.6px] border-[#026AA2] bg-[#E0F2FE] text-[#026AA2]"
        }`}
      >
        {status}
      </span>
