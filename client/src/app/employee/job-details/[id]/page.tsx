      ...
      <div className='flex flex-col gap-6 rounded-xl bg-white p-6 lg:flex-row'>
          ...
          <div className='flex gap-4'>
            {job.status === "Submitted" || job.status === "Rejected" ? (
              ...
              <div>
                ...
                <button className='mt-2 rounded-full bg-[#5B9E9E] px-5 py-[10px] text-sm text-white'>
                  Start Interview
                </button>
              </div>
            ) : (
              <div className='flex gap-3'>
                <button
                  onClick={handleApply}
                  className='rounded-full bg-[#5B9E9E] px-5 py-2 text-white'
                >
                  Apply Now
                </button>
          ...
          <div className='mt-6 flex flex-col gap-2 rounded-xl border px-4 py-4 shadow-sm'>
            ...
            <div className='flex w-full flex-col gap-4 sm:flex-row'>
              ...
              <div className='self-start lg:self-center'>
                <button className='text-base font-semibold whitespace-nowrap text-[#559093]'>
                  View Page
                </button>
              </div>
            </div>
        ...
        <div className='h-full w-full space-y-6 rounded-xl border p-6 lg:w-1/3'>
          ...
          <div className='text-center'>
            <h3 className='mb-3 text-start text-base font-semibold'>
              Profile Match
            </h3>
            <div className='mx-auto w-32'>
              <div className='relative mx-auto h-32 w-32'>
                ...
                />
                <div className='absolute inset-0 flex flex-col items-center justify-center text-sm leading-[18px] font-medium text-[#1A1A1A]'>
            ...
            <p className='mt-3 flex items-center justify-center gap-2 text-sm text-[#5F666C]'>
              <FaCheckCircle size={20} className='text-green-500' />
