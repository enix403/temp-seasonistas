    ...
    <>
      ...
      >
        ...
        <DialogContent sx={{ px: 3, pt: 0, pb: 3 }}>
          <Stack spacing={3}>
            {/* Current Cover Image */}
            {user?.coverPictureUrl && !previewUrl && (
              <Box textAlign="center">
                <Typography variant="subtitle1" gutterBottom>Current Cover</Typography>
            ...
            >
              ...
              <Stack spacing={1} alignItems="center">
                <Typography variant="h6">
                  {isDragActive ? "Drop the image here" : "Drop your cover image here"}
                </Typography>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to remove your cover image? This action cannot be undone.
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button
