...
const Page = () => {
  ...
  const currentInterviews = allInterviews.slice(
    startIndex,
  ...
  return (
    <div className='space-y-6 py-4 sm:px-6'>
      ...
      <div className='overflow-hidden rounded-xl bg-white'>
        <div className='border-b px-6 py-4 text-[20px] leading-[22px] font-medium text-[#1C252E]'>
          All Interviews
        </div>
