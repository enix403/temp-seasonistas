        ...
        <div className='flex w-full items-center justify-between'>
          <div className='flex flex-wrap gap-3 text-sm'>
            <p className='text-sm leading-[22px] font-[400] text-[#1C252E]'>
              Overview <span className='text-[#919EAB]'>• Applicant</span>
            </p>
          </div>
          <div className='flex flex-wrap justify-end gap-3'>
            <button
              className='min-w-[100px] rounded-full bg-[#D95057] px-6 py-2 text-[12px] font-[400] text-white'
              onClick={() => setShowRejectModal(true)}
            >
              Reject
            </button>
            <button
              className='min-w-[100px] rounded-full bg-[#35CC6B] px-6 py-2 text-[12px] font-[400] text-white'
