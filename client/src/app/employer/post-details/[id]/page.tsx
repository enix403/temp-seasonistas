      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <div className='rounded-xl bg-white p-6'>
          <div className='flex items-start justify-between'>
            <h2 className='text-md mb-4 font-semibold'>Step 1</h2>
            <button
              onClick={() => openEditModal(1)}
              className='top-4 right-4 rounded-full bg-[#EEF4F4] p-3 text-[#4F9A98] hover:text-[#3e7e79]'
            >
              <FiEdit2 size={16} />
            </button>
          </div>
          <p className='text-sm font-medium'>Job Title</p>
          <p className='mb-3 text-sm text-gray-600'>{job.title}</p>
          <p className='text-sm font-medium'>Job Location</p>
          <p className='mb-3 text-sm text-gray-600'>{job.location}</p>
          <p className='text-sm font-medium'>Job Category</p>
          <p className='mb-3 text-sm text-gray-600'>{job.category}</p>
        ...
        <div className='rounded-xl bg-white p-6'>
          <div className='flex items-start justify-between'>
            <h2 className='text-md mb-4 font-semibold'>Step 2</h2>
            <button
          ...
          <p className='mb-3 text-sm text-gray-600'>{job.responsibility}</p>
          <p className='text-sm font-medium'>Requirements</p>
          <p className='mb-3 text-sm text-gray-600'>{job.requirements}</p>
        ...
        <div className='rounded-xl bg-white p-6'>
          <div className='flex items-start justify-between'>
            <h2 className='text-md mb-4 font-semibold'>Step 3</h2>
            <button
          ...
          <p className='mb-3 text-sm text-gray-600'>{job.salary}</p>
          <p className='text-sm font-medium'>Job Type</p>
          <p className='mb-3 text-sm text-gray-600'>{job.type}</p>
          <p className='text-sm font-medium'>Required Skills</p>
          <p className='mb-3 text-sm text-gray-600'>{job.skills.join(", ")}</p>
        ...
        <div className='rounded-xl bg-white p-6'>
          <div className='flex items-start justify-between'>
            <h2 className='text-md mb-4 font-semibold'>Step 4</h2>
            <button
