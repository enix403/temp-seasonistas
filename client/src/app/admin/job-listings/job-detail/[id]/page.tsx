        ...
        <div className='flex items-start justify-between'>
          <div className='space-y-1'>
            ...
            <p className='text-[14px] font-normal text-[#637381]'>
              Posted on {formatDate(new Date(job.date))} &nbsp; Expire on{" "}
              {formatDate(new Date(job.expireDate))}
            </p>
            <p className='text-[16px] font-normal text-[#1C1C1EB8]'>
              <strong className='font-semibold text-[#1C1C1E]'>Job ID:</strong>{" "}
              {job.id}
            </p>
              ...
              className={`rounded-full px-5 py-2 text-sm font-medium ${
                job.status === "Active"
                  ...
                  : job.status === "Rejected"
                    ...
                    : "border-[0.6px] border-[#F3C44D] bg-[#F3C44D2B] text-[#F3C44D]"
              }`}
            >
              {job.status}
            </div>
