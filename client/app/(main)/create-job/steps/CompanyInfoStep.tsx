...
const fileLogo = (
  <svg
    className="mx-auto text-teal-dark"
    width={40}
    height={40}
    viewBox="0 0 40 40"
    fill="none"
...
function LogoInput({ register, watch, reset }: any) {
  ...
  return (
    <div>
      ...
      {/*  */}
      <div className="w-full py-9 bg-white rounded-2xl border border-gray-300 gap-3 grid border-dashed">
        {/* Logo */}
        {fileLogo}
        {/* Line 1 */}
    ...
    <>
      ...
      <StepForm onNext={onNext}>
        <div className="bg-teal/5 p-7 mt-7 rounded-xl space-y-6">
          ...
          <LogoInput register={register} watch={watch} reset={reset} />
          ...
          <FormLabel label="Date Posted">
            <Input
              {...register("postedAt")}
              type="date"
              placeholder="Select the date posted"
            />
          </FormLabel>
